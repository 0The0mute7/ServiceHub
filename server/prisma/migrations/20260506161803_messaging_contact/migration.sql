-- AlterTable
ALTER TABLE "Service" ADD COLUMN     "contact" TEXT NOT NULL DEFAULT '';
...
-- CreateIndex
CREATE UNIQUE INDEX "Conversation_serviceId_buyerId_providerId_key" ON "Conversation"("serviceId", "buyerId", "providerId");
